...
//     * pageSize 每页显示的数据条数
//     * */
//    public PageInfo<Question> getQuestionList(Integer  pageNum, Integer  pageSize) {
//        List<Question> questions = mapper.findList(new Question());
//        PageInfo result = new PageInfo(questions);
//        return result;
//    }
...
//        if(0 != entity.getId() && null != entity.getId()){
//            code = mapper.edit(entity);
//        }else{
